...
Namespace WordProcessorLayoutAPISample
    ...
    Friend Class Program
        ...
        Shared Sub Main(ByVal args As String())
            Using rtfProcessor As RichEditDocumentServer = New RichEditDocumentServer()
                ...
                Dim b As Bookmark = rtfProcessor.Document.Bookmarks.Where(Function(b) Equals(b.Name, "Appendix")).FirstOrDefault()
